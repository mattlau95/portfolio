...
# Curating Amazon Images #

"Curator" would be a great word to describe my niche role at Aduro. I was responsible for all graphics posted on our new Amazon product listings- I made sure that all images are the correct dimensions, and also are visually presented in a way that results in more conversions (or sales). One of my most important roles was providing aesthetic representations of the products without misleading the customers who purchase the product (this can lead to bad reviews). I'll provide a "blog-style" example of some of the things I "curate" for our Amazon listings.

## Creating the right group of images ##
...
[img/aduro_3.png here]
Can you catch the difference? On the left, the woman is wearing headphones, and the vest of course. Also the vest has striped own the middle. The image on the left doesn't have the stripe, but the real product did, so I had to add it.
...
[https://youtu.be/ZqXNbpCdji4]

This product can be found here: [URL here, Text: Aduro Foldable Fast Wireless Charger. URL: https://www.amazon.com/Aduro-Wireless-Qi-Certified-Charging-Fordable/dp/B07NZY11SY/]

[https://youtu.be/wdymnPDj0NY]

This product can be found here: [URL here, Text: Aduro Foldable Fast Wireless Charger. URL: https://www.amazon.com/s?k=smartphone+grip+desk&ref=nb_sb_noss_2]